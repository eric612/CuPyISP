...
class DWT:
    ...
    def execute(self):
        ...
        img = cp.asarray(self.img, dtype='int16')
        ...
        #print(pad_w,pad_h)
        self.denoise((img_w//8,img_h//8), (8,8), (img_pad,img_w,img_h,pad_w,pad_h,search_dis,kernel_size,self.h,nlm_img))  # grid, block and arguments  
        '''
        img2_L1[:img_h,:img_w] = img2_L2
        img_w = img_w*2
        img_h = img_h*2
        ...
        pad_h = img_pad.shape[0] - img_h
        #print(pad_w,pad_h)
        self.denoise((img_w//16,img_h//16), (16,16), (img_pad,img_w,img_h,pad_w,pad_h,search_dis,kernel_size,self.h,nlm_img))  # grid, block and arguments   
        '''
        img[:img_h,:img_w] = img2_L1
        img_w = img_w*2
        img_h = img_h*2   
        ...
        pad_h = img_pad.shape[0] - img_h
        #print(pad_w,pad_h)
        self.denoise((img_w//8,img_h//8), (8,8), (img_pad,img_w,img_h,pad_w,pad_h,search_dis,kernel_size,self.h,img))  # grid, block and arguments            
        #self.img = dwt_img
